...
for angle in np.arange(0, 180, 30):
    srt_point = (int(center_h - radius * math.sin(math.radians(angle))), int(center_h - radius * math.cos(math.radians(angle))))
    end_point = (int(center_h + radius * math.sin(math.radians(angle))), int(center_h + radius * math.cos(math.radians(angle))))
